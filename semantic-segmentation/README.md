...
- Rich maps
Rich maps are generated by running python script [Contribution guidelines for this project](pcl-augmentation/semantic-segmentation/rich_map/driveable_area_map.py)
- Object database
