...
def main(args):
    ...
    pytorch_device = torch.device('cuda:'+str(args.cuda))
    ...
    with torch.no_grad():
        for i_iter_demo, (_, demo_vox_label, demo_grid, demo_pt_labs, demo_pt_fea) in enumerate(
            ...
            predict_labels = my_model(demo_pt_fea_ten, demo_grid_ten, batch_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument( '--cuda', type = int, help = 'Which cuda you want to connect', required = True)
